...
const MovieDetails = () => {
  ...
  useEffect(() => {
    const movie_id = fetch(
      `https://api.themoviedb.org/3/movie/${id}?api_key=1d9d2a6f682b3e2bedca7ee06616fa88&language=en-US`
    );
    movie_id
      .then((res) => res.json())
    ...
    const creditsData = fetch(
      `https://api.themoviedb.org/3/movie/${id}/credits?api_key=1d9d2a6f682b3e2bedca7ee06616fa88&language=en-US`
    );
    creditsData
      .then((res) => res.json())
